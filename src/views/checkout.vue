      ...
      <div class="justify-end mt-6" v-if="steps == 2">
        ...
        <form action="" v-if="!useData">
          <div class="flex space-x-20">
            <div class="">
              ...
              <input
                type="text"
                name="email"
                class="peer block w-full form-input my-3 ml-3 appearance-none border-0 border-b border-green-700 bg-slate-100 py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0"
            ...
            <div class="">
              ...
              <input
                type="text"
                name="email"
                class="peer block w-max form-input my-3 ml-3 appearance-none border-0 border-b border-green-700 bg-slate-100 py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0"
          ...
          <input
            ...
            name="email"
            :maxlength="11"
            class="peer block w-[80%] form-input my-3 ml-3 appearance-none border-0 border-b border-green-700 bg-slate-100 py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0"
